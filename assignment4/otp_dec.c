...
//This is decryption CLIENT.
//This program ciphertext form the first param file.
//It then sends that ciphertext along with the key to decryption server to do the actual decryption.
//Once plain text is received back from server, it is printed out to stdout.
